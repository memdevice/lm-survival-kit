...
*Questo modulo contiene la mia configurazione della tastiera =US Intranational layout= (/sic/) e lo script aggiuntivo necessario per configurarla su Windows 10.*
