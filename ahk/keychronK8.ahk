...
;; il tasto sotto il Return, uno a sinistra
SC028::Send {U+0027} 		;; quote \'
+SC028::Send {U+0022}		;; doublequote \"

;; - Gestione del "tasto duplicato" (cfr. anche keychronK6.ahk)
...
<^>!SC02B::Send {U+00B6} 	;; ¶ Pilcrow Sign paragraph sign U+00B6
;; NB: AltGr di default contiene ancora il not logico ¬
<^>!+SC02B::Send {U+00A9} 	;; © Copyright Sign Emoji copy , (c) U+00A9
