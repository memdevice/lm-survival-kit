...
;; sistemato i tasti per l'accento grave (aeiou)
;; aggiunto e risistemato i tasti per l'accento acuto (zdhkl)
;; mantenuto l'associazione tra î Î e il tasto <J>

;; aggiunto il segno di grado (°) sul tasto duplicato di destra
;; aggiunto il segno di sezione (§) sul +tasto duplicato di destra
;; aggiunto il segno di paragrafo (¶) sul <^>!tasto duplicato di destra
;; aggiunto il segno di ceciright (©) sul <^>!+tasto duplicato di destra
;; aggiunto i due segni ※ e ⁜ associati AltGr e AltGr Shift tasto duplicato di sinistra 

;; BUILT IN su [ ] ;; aggiungere i caporali: UTF-8 00AB « e 00BB »
